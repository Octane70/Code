...
LA = Label(root, text ="Timer").grid(row=9, column=1, rowspan=1, columnspan=2, sticky=W)
L6 = Label(root, text ="Manual").grid(row=9, column=2, rowspan=1, columnspan=2, sticky=W)
L7 = Label(root, text ="Zone2").grid(row=11, column=0, rowspan=1, columnspan=2, sticky=W)
LB = Label(root, text ="Timer").grid(row=11, column=1, rowspan=1, columnspan=2, sticky=W)
L8 = Label(root, text ="Manual").grid(row=11, column=2, rowspan=1, columnspan=2, sticky=W)
L9 = Label(root, text ="Red = On").grid(row=13, column=0, rowspan=1, columnspan=1, sticky=W)
L10 = Label(root, text ="Black = Off").grid(row=14, column=0, rowspan=1, columnspan=1, sticky=W)
L11 = Label(root, text ="Yellow = Auto").grid(row=15, column=0, rowspan=1, columnspan=1, sticky=W)
L12 = Label(root, text ="Zone1 On:").grid(row=17, column=0, sticky=W)
L13 = Label(root, text ="Timer set:").grid(row=18, column=0, sticky=W)
L14 = Label(root, text ="Zone2 On:").grid(row=19, column=0, sticky=W)
L15 = Label(root, text ="Timer set:").grid(row=20, column=0, sticky=W)
...
#Frames
frame1 = Frame(root, borderwidth=5, bg="black", relief="ridge", width=200, height=4)
...
#Frame grids
frame1.grid(row=7, column=0, columnspan=2, rowspan=1, sticky=W)
frame2.grid(row=10, column=0, columnspan=2, rowspan=1, sticky=W)
frame3.grid(row=12, column=0, columnspan=2, rowspan=1, sticky=W)
frame4.grid(row=16, column=0, columnspan=2, rowspan=1, sticky=W)
...
T1.insert("1.0", "0700\n") #Default value
T1.grid(row=17, column=1, sticky=W)

T2 = Text(root, width=10, height=1)
T2.insert("1.0", "0030\n") #Default value
T2.grid(row=18, column=1, sticky=W)

T3 = Text(root, width=10, height=1)
T3.insert("1.0", "1900\n") #Default value
T3.grid(row=19, column=1, sticky=W)

T4 = Text(root, width=10, height=1)
T4.insert("1.0", "0030\n") #Default value
T4.grid(row=20, column=1, sticky=W)

T5 = Text(root, width=10, height=1)
T5.insert("1.0", "00:00:00\n") #Default value         
T5.grid(row=10, column=1, sticky=W)

T6 = Text(root, width=10, height=1)
T6.insert("1.0", "00:00:00\n") #Default value
T6.grid(row=12, column=1, sticky=W)
...
B2.grid(row=12, column=2, sticky=W)
...
B3.grid(row=17, column=2, sticky=W)
...
B4.grid(row=18, column=2, sticky=W)
...
B5.grid(row=19, column=2, sticky=W)
...
B6.grid(row=20, column=2, sticky=W)
