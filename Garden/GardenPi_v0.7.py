...
from Adafruit_Char20x4LCD import Adafruit_CharLCD
import subprocess
...
root = Tk()   
time1 = ''
root.title("Irrigation GUI v0.7")
...
LA = Label(window1, text="Moisture3 =").grid(row=5, column=0, sticky=W)
L5 = Label(window1, text="CPU Temp =").grid(row=6, column=0, sticky=W)
L6 = Label(window1, text="Case Temp =").grid(row=7, column=0, sticky=W)
...
L29 = Label(window1, text ="Camera On/Off:").grid(row=9, column=0, sticky=W)
L30 = Label(window1, text ="Close GUI:").grid(row=11, column=0, sticky=W)
...
L36 = Label(window4, text="Irrigation GUI designed by Rob Czepil 2014-2016").grid(row=6, column=0, sticky=W)
...
frame8 = Frame(window4, borderwidth=5, bg="grey", relief="ridge", width=300, height=4)   #Divider4

#Frame grids
frame1.grid(row=8, column=0, columnspan=2, rowspan=1, sticky=W)  #Divider1
...
frame8.grid(row=5, column=0, columnspan=2, rowspan=1, sticky=W)  #Divider4
...
B13.grid(row=10, column=0, sticky=W)
...
B14.grid(row=12, column=0, sticky=W)
...
def gui_widgets():
   ...
   Label(window1, textvariable=moist3).grid(row=5,column=1,sticky=W)
   Label(window1, textvariable=cputemp).grid(row=6,column=1,sticky=W)
   Label(window1, textvariable=casetemp).grid(row=7,column=1,sticky=W)
